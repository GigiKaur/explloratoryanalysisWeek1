...
# Set up a custom layout for plots
...
plot(subpower$Time, as.numeric(as.character(subpower$Global_reactive_power)), type = "l", xlab = "Datetime", ylab = "Global Reactive Power")
